<template>
  <div class="page-wrapper page-wrapper--scroll">
    ...
    <div class="action-container">
      <h3>Slide</h3>
      <div class="slide__actions g">
        <div class="gi gi-1-2 slide__action" v-for="slide in slides" :key="slide">
      ...
      <div class="g">
        <div class="gi">
          <button class="btn btn--big" v-bind:class="{ 'btn-c2a btn--loading': states.autoplay }" @click.prevent="toggleSlideAutoplay()">
            Autoplay
            <span v-if="states.autoplay">ausschalten</span>
            <span v-else>einschalten</span>
          </button>
        </div>
      </div>
    </div>
    ...
    <div class="action-container">
      ...
      <div class="g">
        <div class="gi">
          <button class="btn btn--big" @click="playGong()">Gong {{states.gong}}</button>
        </div>
      </div>
  ...
  export default {
    ...
    data () {
      return {
        hashtag: null,
        soundcloudUrlInput: '',
        slides: ['wand', 'speakers', 'sponsors', 'next', 'nowplaying']
      }
    },
    methods: {
      logout: function () {
